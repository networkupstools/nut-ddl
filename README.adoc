...
# DEVICE:COMMENT-BLOCK:UPSCONF: # title ignored
# [ups]
#   driver = blazer_ser
#   port = /dev/ttyUSB0
...
# DEVICE:COMMENT-BLOCK:LSUSB: `lsusb -vvv` # optional title with exact command, possibly not `lsusb` per se on some OSes
# ...
# DEVICE:EOC
...
# DEVICE:COMMENT-BLOCK:LOGS: Console messages of NUT driver startup # optional title with description of the log
# ...
# DEVICE:EOC
...
# DEVICE:COMMENT-BLOCK:FIXME:UPSRW: # title ignored
# [battery.charge.low]
...
# DEVICE:COMMENT-BLOCK:FIXME:UPSCMD: # title ignored
