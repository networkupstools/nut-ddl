...
In addition to that, users are invited to use them to report their experience
with NUT to help improve support for their devices and help other users:
to do so, you may want to add some <<special-comments,`special' comments>>,
...
So you can easily create definition files on your NUT system from an existing
UPS or another power device, using "+upsc > file.dev+".
